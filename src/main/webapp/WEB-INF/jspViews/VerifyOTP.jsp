    ...
    <div id="formWrapper">
      ...
      <form action="verify.html">
                  <div class="form-group">
                     ...
                     <input type="text" name="otp" placeholder="Enter your One Time Password" class="form-style">
                  </div>
                  
                  <button type="submit" id="button" class="login pull-right text-active">Verify</button>
