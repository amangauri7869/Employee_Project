...
<div id="myModal" class="modal" style="display:none;">
  ...
  <!-- Modal content -->
  <div class="modal-content" style="position:absolute; margin-top:240px; margin-left:400px; width:200px;">
    <span class="close" onclick="closeMessage()">&times;</span>
    <p id="responseMessage" style=""></p>
    <button type="button" class="btn bg-dark text-active" onclick="closeMessage()" style="">Okay</button>
  </div>
    ...
    document.addEventListener("adobe_dc_view_sdk.ready", function () {
        ...
        var previewFilePromise = adobeDCView.previewFile({
            ...
            content: {
                ...
                location: {
                    url: "http://localhost:8087/employee_management/renderPdf.html?complianceId=${complianceId}"
        ...
        previewFilePromise.then(function (adobeViewer) {
            ...
            /* 	$.post("http://localhost:8080/employee_management/updatePdf.html",{file:blob}, function(result){
                ...
                $.ajax({
                    url: "http://localhost:8087/employee_management/updatePdf.html", 
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function(data) {
                    	...
                    	/* display message box starts*/
                    	
                
                    	displayMessage(data);
                    	
                    	/* display message box ends*/
            ...
            $(function() {
            	  $('button[type=submit]').click(function(e) {
            	    ...
            	    var ajaxReq = $.ajax({
            	      url : 'http://localhost:8087/employee_management/uploadComment.html',
            	      type : 'POST',
            	      data : formData,
            	      cache : false,
            	      contentType : false,
            ...
            function displayMessage(data){
            	...
            	// Get the modal
            	var modal = document.getElementById("myModal");
            	var messagePara =  document.getElementById('responseMessage');
